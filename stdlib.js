...
$["ei"]=(h,i,j,k,X,Y,Z)=>(i=shift(),setInterval(a=>exec(i),shift())) //`es` at millisecond intervals given by index 1
$["et"]=(h,i,j,k,X,Y,Z)=>(i=shift(),setTimeout(a=>exec(i),shift())) //`es` after waiting milliseconds given by index 0
